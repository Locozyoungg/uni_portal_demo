...
const navSections: NavSection[] = [
  {
    ...
    icon: BookOpen,
    items: [
      { label: 'Registration', href: '/dashboard/academics/registration', icon: BookOpen },
      { label: 'Units', href: '/dashboard/academics/registered-units', icon: BookMarked },
      { label: 'Results', href: '/dashboard/academics/results', icon: Award },
      { label: 'Transcript', href: '/dashboard/academics/transcript', icon: ScrollText },
      { label: 'Exam Card', href: '/dashboard/academics/exam-card', icon: FileText },
      { label: 'Attendance', href: '/dashboard/academics/attendance', icon: CheckSquare },
      { label: 'CGPA', href: '/dashboard/academics/cgpa', icon: TrendingUp },
    ],
  },
  {
    title: 'Finance',
