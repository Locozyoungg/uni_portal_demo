...
function PaymentsError({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <h3 className="mt-4 text-lg font-semibold text-gray-900">Failed to load hostel payments</h3>
...
function PaymentsEmpty() {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <h3 className="mt-4 text-lg font-semibold text-gray-900">No hostel payments yet</h3>
      <p className="mt-1 text-sm text-gray-500">
        No hostel-related payments have been recorded yet.
      </p>
    </div>
  );
}
...
export default function HostelPaymentsPage() {
  ...
  const { data, isLoading, isError, refetch } = useQuery<
    ApiResponse<HostelPaymentsData>
  >({
    queryKey: ['hostel-payments'],
    queryFn: () => api.get('/hostel/payments').then((r) => r.data),
  });
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-ku-navy">Hostel Payments</h1>
            <p className="text-sm text-gray-500">
              Track your hostel accommodation payments
            </p>
          </div>
        </div>
      </motion.div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-ku-navy">
                      {formatCurrency(paymentsData.currentPeriodAmount || 0)}
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-ku-navy">{paymentsData.paymentCount}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-yellow-700">{paymentsData.pendingCount}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <CardContent className="p-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Search by reference, description, or period..."
                  value={searchQuery}
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                {filteredPayments.length} of {payments.length} hostel payments
              </CardDescription>
            </div>
            <Badge variant="outline" className="text-xs">
              {formatCurrency(paymentsData?.totalPaid || 0)} total
            </Badge>
          </CardHeader>
          <CardContent>
